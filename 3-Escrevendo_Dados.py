...
print("Exemplo 1")
arquivo = "8-Arquivos_Exceções/3-Exemplo_1.txt"
...
"""Abaixo temos o exemplo de um arquivo foi criado para exemplificar"""

print("\nExemplo 2")
arquivo_2 = "8-Arquivos_Exceções/novo_arquivo.txt"
...
"""
    O segundo argumento #w diz a Python que queremos abrir o arquivo em #modo de escrita, assim também temos: 
    ...
    A função open() cria automaticamente o arquivo no qual você vai escrever caso ele ainda não exxista. Tome cuidado ao abrir um arquivo em modo de escrita ("w") porque se o arquivo já existir, Python o apagará antes de devolver o objeto arquivo. 
...
print("\nExemplo 3")
arquivo_3 = "8-Arquivos_Exceções/3-Exemplo_1.txt"
...
Concatenando dados em um arquivo
    ...
    Vamos utilizar como o exemplo o anterior para concaternar com novas frases."""
